...
$SEGNode = &$periods[0]['adaptationSet'][0]['representation'][0]['segmentTemplate']['node'];
#$VID_Dur = $SEGNode->getAttribute("duration");
#$VID_Dur = $SEGNode[0]->getAttribute("duration");
$VID_Dur = $SEGNode[0]->duration;
#$VID_Tim = $SEGNode->getAttribute("timescale");
#$VID_Tim = $SEGNode[0]->getAttribute("timescale");

$AST_BCST = $PTP - $ST_UTC - $Delay;
file_put_contents ( "timelog.txt" , "Setting AST: " . $AST_BCST . " \r\n" , FILE_APPEND );
file_put_contents ( "timelog.txt" , "Video Duration: " . $VID_Dur . "Video Timescale: " . $VID_Tim . " \r\n" , FILE_APPEND );
